 ...
 * <p>
 * Implements feature F3.3 using a minimal contract to decouple domain
 * retrieval (F3.2) from formatting/display. Null or blank locations are
 * rendered as a generic reference to the user's location.
 */
@Component
