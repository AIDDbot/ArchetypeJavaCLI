 ...
 *
 * <p>
 * These codes are used consistently across the application to signal outcome to
 * the caller
 ...
 * <li>{@link #RUNTIME} – Uncaught runtime errors that aren’t IO or network
 * related.
 * <li>{@link #IO} – Local filesystem or stream errors (e.g.,
 * {@link java.io.IOException}).
 * <li>{@link #NETWORK} – Remote connectivity issues (timeouts, DNS, connect
 * failures).
