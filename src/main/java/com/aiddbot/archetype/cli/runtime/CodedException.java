...
/**
 * Exception carrying an {@link ExitCodes} value to signal a specific failure
 * category at the
 * process boundary.
 *
 * <p>
 * Throw this for anticipated error conditions where the exit code is part of
 * the contract (e.g.,
 * user misuse or domain-specific failures). Unknown/coding errors should be
