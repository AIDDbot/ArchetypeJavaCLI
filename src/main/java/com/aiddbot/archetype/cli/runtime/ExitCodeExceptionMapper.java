 ...
 *
 * <p>Implementations should be deterministic and side-effect free. They may unwrap custom
 * wrapper exceptions and should prefer specific categories (e.g., network vs IO) before generic
 * runtime failures.
 */
